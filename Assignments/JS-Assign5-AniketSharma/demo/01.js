window.onload = function () {
    var API_KEY = "e208071fec091f20061bb284eaa9bb4";
      ...
      xhr.onreadystatechange = function () {
        if (xhr.readyState === 4) {
          if (xhr.status === 200) {
            ...
            outWindSpeed.innerHTML =  DATA.wind.speed + ' m/s'; // Display wind speed
    ...
    buttons.forEach((button) => {
      button.addEventListener("click", () => Weather(button.id));
    });
